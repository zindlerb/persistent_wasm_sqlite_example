...
** SQLITE_SOURCE_ID "2022-10-14 15:52:29 a4423ca234453c14eb40db7fe5943f63b30fd9dc2207388e8a2966733a004e9d"
*/
...
/* BEGIN FILE: sqlite3-api.js */
/* BEGIN FILE: sqlite3-license-version.js */
/*
** LICENSE for the sqlite3 WebAssembly/JavaScript APIs.
**
** This bundle (typically released as sqlite3.js or sqlite3-wasmfs.js)
...
** SQLITE_SOURCE_ID "2022-10-14 15:52:29 a4423ca234453c14eb40db7fe5943f63b30fd9dc2207388e8a2966733a004e9d"
*/
/* END FILE: sqlite3-license-version.js */
...
/* BEGIN FILE: api/sqlite3-api-build-version.js */
self.sqlite3ApiBootstrap.initializers.push(function(sqlite3){
  sqlite3.version = {"libVersion": "3.40.0", "libVersionNumber": 3040000, "sourceId": "2022-09-20 16:20:35 1b5f1b4a6c1457f98c258459e23e321fc59793de298fecb84031b87f0215alt1"};
});
/* END FILE: api/sqlite3-api-build-version.js */
...
const installOpfsVfs = function callee(asyncProxyUri = callee.defaultProxyUri){
  ...
  const thePromise = new Promise(function(promiseResolve, promiseReject_){
    ...
    */
    ...
    console.log('options.proxyUri', options.proxyUri)
